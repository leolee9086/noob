...
router.use("/outline",require('./outline/index.js.js'))
...
router.use("/sync",require("./sync/index.js.js"))
...
router.use("/importer",require("./importer/index.js.js"))
router.use("/template",require("./template/index.js"))
router.use("/transactions",require("./transactions/index.js.js"))
