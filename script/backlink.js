 ...
 const backlinks  = Vue.createApp({
    template:`<cc-block-list
    :blocklist="反向链接列表"
    ></cc-block-list>`,
    mounted(){
...
backlinks.component("cc-block-list",{
    template:`
    ...
    >
      ...
      <el-link
        :href='"/?blockid="+item.id'  v-if="item.box"
...
backlinks.use(ElementPlus);
backlinks.mount("#backlinks");
