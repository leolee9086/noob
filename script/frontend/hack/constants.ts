...
const _SIYUAN_VERSION = "2.4.0";
const _NODE_ENV = {};

export  class Constants {
    public static readonly SIYUAN_VERSION: string = "2.4.0";
    ...
    public static readonly PROTYLE_CDN: string = "http://127.0.0.1:6806/stage/protyle";
