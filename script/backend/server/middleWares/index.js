...
export const bodyParser = requireInstall("body-parser")
export const compression = requireInstall("compression")()
export const json = bodyParser.json()
export const session = requireInstall("express-session")({
    secret: "Auth", // 必选配置
...
export const passport= requireInstall('passport')
export default   {
