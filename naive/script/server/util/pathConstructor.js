...
export default class pathConstructor {
  ...
  naivePath() {
    return `${this.workspaceDir}/conf/appearance/themes/${this.themeName}/naive`;
  }
  pluginsPath() {
  ...
  corePluginsPath() {
    return `${this.workspaceDir}/conf/appearance/themes/${this.themeName}/naive/script/plugin/corePlugins`;
  }
  sslPath() {
    let fs = require("fs");
    let path = require("path");
