...
const ifdefParser = class {
  ...
  Parser(source, filePath, options) {
    ...
    if (options&&options.defs) {
      defs= options.defs
      verbose= options.verbose?options.verbose:this.options.verbose
      tripleSlash= options.tripleSlash?options.tripleSlash:this.options.tripleSlash
      fillWithBlanks= options.fillWithBlanks?options.fillWithBlanks:this.options.fillWithBlanks
      uncommentPrefixString= options.uncommentPrefixString?options.uncommentPrefixString:this.options.uncommentPrefixString
    } 
    if(options&&!options.defs){
      defs= options
